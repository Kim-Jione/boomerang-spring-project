                        ...
                        <ul class="list-items">
                          ...
                          <span class="checkbox">
                            <i class="fa-solid fa-check check-icon"></i>
                                ...
                                <span class="item-text" value="남성" name="jobGender">남성</span>
                            </li>
                            <li class="single_item">
                          <span class="checkbox">
                            <i class="fa-solid fa-check check-icon"></i>
                          </span>
                                <span class="item-text" value="여성" name="jobGender">여성</span>
                            </li>
                            <li class="single_item">
                          <span class="checkbox">
                            <i class="fa-solid fa-check check-icon"></i>
                          </span>
                                <span class="item-text" value="성별 무관" name="jobGender">성별 무관</span>
                            </li>
                        </ul>
                    </dd>
                </dl>
