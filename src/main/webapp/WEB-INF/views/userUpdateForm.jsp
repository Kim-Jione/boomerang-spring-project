...
<html lang="ko">
  <head>
   ...
   <link rel="stylesheet" href="/css/default.css"/>
    ...
    <link href="https://fonts.googleapis.com/css?family=Material+Icons|Material+Icons+Outlined|Material+Icons+Two+Tone|Material+Icons+Round|Material+Icons+Sharp" rel="stylesheet"><title>수정하기</title>
    ...
    <div class="myPage">
          ...
          <div class="container">
            ...
            <div class="pro_right">
              <div class="name">
                <p>
                  <input id="user_nickname" type="text" value="${userDetail.userNickname}" /><button
                    class="save"
                    onclick=""
                  >
                    저장하기
              ...
              <div class="profile_con">
                ...
                <div class="profile_txt">
                  <div class="pro_txt pro_info">
                    ...
                    <ul class="pro_info2">
                      <li>
                        <label for="male">${userDetail.userGender}</label>
                        <input
                          type="radio"
                          class="user_gender"
                          name="user_gender"
                    ...
                    <div class="pro_txt">
                      ...
                      <p class="pro_data">
                        <input                          type="text"                          id="user_education"
                          value="${userDetail.userEducation}"       />
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="profile_txt">
                  ...
                  <div class="pro_txt">
                    ...
                    <div>
                      <div>
                        <p class="pro_data kakao">오픈 채팅<input
                          class="user_contact"
                          type="text"
                          id="user_contact"
                          value="${userDetail.userContactLink}"
                        /></p>
